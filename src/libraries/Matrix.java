...
public class Matrix {
	...
	public double[][] setMatrix(double a[][]) {
		matrix = a;
		// wenn die Dimensionen der �bergegebenen Matrix mit X und Y �berienstimmen,
	...
	// matrix multiply
	 public Matrix multiple(Matrix b) throws Exception{
		 ...
		 if (this.M != b.N) {
				//throw new IllegalArgumentException("Die Anzahl der Spalten der Matrix a m�ssen der Anzahl der reihen von matrix B gleichen.");
		}					 
